    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f7fdec] to-[#e6f5d0] flex">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-auto pb-24">
        ...
        >
          ...
          <div className="sticky bottom-0 left-0 right-0 mt-8 pt-6 pb-2 bg-gradient-to-t from-white/80 to-transparent -mx-6 md:-mx-10 px-6 md:px-10">
            <Button 
        ...
        <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-xl border-t border-border/30 px-4 py-2 z-50">
